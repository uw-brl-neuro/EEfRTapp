...
import csv
header = ['NameV1_1', 'TrialNumber', 'T-TrialStart', 'Probability', 'TaskLevel', 'T-DecisionMade', 'PromptedReward', 'SelectedReward', 'CompleteLevel', 'CompleteStatus', 'T-TaskComplete', 'WinningStatus']
data_collection = []
