...
class TrialCue(tk.Frame):
    def __init__(self, master):
        ...
        self.after(0, lambda: master.switch_frame(TrialChoose))
...
class TrialChoose(tk.Frame):
    def __init__(self, master):
        ...
        self.after(0, lambda: self.switch_to_Task(master))
...
class Task(tk.Frame):
    def __init__(self, master):
        ...
        master.set_frame_switch_status(False)
        self.after(0, lambda: self.switch_to_RandomPage(master, progress, maximum_level))
    ...
    def switch_to_RandomPage(self, master, progress, maximum_level):
        random_status = random.randint(0, 1)
        if random_status == 0:
            self.switch_to_FailPage(master)
        else:
            while indicator.get() != maximum_level:
                progress.step(1)
            global complete_status
...
class CompleteStatusPage(tk.Frame):
    def __init__(self, master):
        ...
        self.after(0, lambda: master.switch_frame(WinningStatusPage))
